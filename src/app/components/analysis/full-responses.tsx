...
const questionMap: Record<keyof FormValues, string> = {
    ...
    averageProcessingTime: "On average, how long does it take to complete one request from start to finish?",
    costPerTransaction: "What is the estimated cost to process a single request?",
    ...
    errorRate: "Approximately what percentage of requests require rework due to errors?",
    ...
    processStandardization: "What percentage of requests follow the exact same steps?",
    exceptionHandling: "What percentage of requests require special handling or don't follow the standard process?",
